                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="text-right">
                                    @if(!empty($filter) && $filter)
                                        <a href="{{ route('branch.list') }}" class="mr-3 text-red-600"><span class="bi bi-x-circle"> </span>Filtreleri temizle</a>
                                    @endif
                        ...
                        <table class="table-auto w-full">
                            ...
                            @foreach ($branches as $branch)
                                <tr>
                                    ...
                                    <td class="text-center py-2">{{ $branchTypes[$branch->type] }}</td>
